...
/**
 * Created by Craig on 11/3/2015.
 */
public class ZoomableImage extends ImageView implements View.OnTouchListener {
    ...
    public ZoomableImage(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoomableImage(Context context, AttributeSet attrs, int defStyle) {
